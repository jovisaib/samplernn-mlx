...
import mlx.nn as nn
from mlx.utils.trainer.plugins.plugin import Plugin
from mlx.utils.trainer.plugins.monitor import Monitor
from mlx.utils.trainer.plugins import LossMonitor
...
class ValidationPlugin(Plugin):
    ...
    def _evaluate(self, dataset):
        ...
        for data in dataset:
            ...
            batch_inputs = [mx.array(input) for input in batch_inputs]
...
class GeneratorPlugin(Plugin):
    ...
    def register(self, trainer):
        self.generate = Generator(trainer.model.model)

    def epoch(self, epoch_index):
        samples = self.generate(self.n_samples, self.sample_length).numpy()
